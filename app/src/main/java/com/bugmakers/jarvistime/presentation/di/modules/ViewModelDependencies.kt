...
import com.bugmakers.jarvistime.presentation.common.base.ViewModelFactory
...
import com.bugmakers.jarvistime.presentation.pages.home.HomeActivityViewModel
import com.bugmakers.jarvistime.presentation.pages.home.inbox.InboxFragmentViewModel
...
internal fun viewModelDependencies() = Kodein.Module("viewModelDependencies") {
    ...
    bindViewModel<InboxFragmentViewModel>() with provider { InboxFragmentViewModel(instance(), instance()) }
}